...
| Last remeasure | 2026-08-07, Rust `0e0f7eb` plus the checkpoints work. Only the four parts `tasks/prd-checkpoints-parity.md` touched were remeasured, so the weighted total below predates them, as it already predated the four EP-029 touched at the 2026-08-06 remeasure |
